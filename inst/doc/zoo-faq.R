...
## ----log-plot, fig.height=5, fig.width=5--------------------------------------
z <- zoo(1:100)
plot(z, log = "y", panel = function(..., log) lines(...))

## ----plot-axes, fig.height=5, fig.width=5-------------------------------------
set.seed(1)
...
## ----single-panel, fig.height=5, fig.width=5----------------------------------
...
## ----multiplesingleplot, fig.height=9, fig.width=9----------------------------
...
## ----multipanelplot, fig.height=9, fig.width=9--------------------------------
...
## ----plot-with-na, fig.height=5, fig.width=5----------------------------------
z <- zoo(c(1, NA, 2, NA, 3))
plot(z)

## ----plot-with-na1, fig.height=5, fig.width=5---------------------------------
plot(z, type = "p") 

## ----plot-with-na2, fig.height=5, fig.width=5---------------------------------
plot(na.omit(z))

## ----plot-with-na3, fig.height=5, fig.width=5---------------------------------
plot(na.approx(z))

## ----plot-with-na4, fig.height=5, fig.width=5---------------------------------
plot(z, type = "p")
lines(na.omit(z))

## ----Rmetrics, fig.height=5, fig.width=5--------------------------------------
library("timeDate")
...
## ----Rmetrics-detach, include=FALSE-------------------------------------------
detach("package:timeSeries")
detach("package:timeDate")

## ----CRAN_package_db, eval=FALSE----------------------------------------------
