...
\emph{This section war written when \pkg{tseries} did not yet support \code{"zoo"}
...
using a \code{"Date"} index. The log-difference returns for Microsoft
...
\pkg{zoo} 1.5--0,
\pkg{strucchange} 1.3--2,
\pkg{fCalendar} 262.73,
\pkg{tseries} 0.10--14 and
\pkg{DAAG} 0.97.
